 ...
 */
final class Version20220113073748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encyclopedie_du_personnage ADD encyclopedie_des_personnages_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE encyclopedie_du_personnage DROP encyclopedie_des_personnages_id');
    }
}
