 ...
 */
final class Version20220113154920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_personnage_rarete_ssr (id INT AUTO_INCREMENT NOT NULL, img VARCHAR(255) NOT NULL, descriptionleaderskill LONGTEXT NOT NULL, nomsuperattaque VARCHAR(255) NOT NULL, descriptionsuperattaque LONGTEXT NOT NULL, nompassiveskill VARCHAR(255) NOT NULL, descriptionpassiveskill LONGTEXT NOT NULL, listedesliensdupersonnages LONGTEXT NOT NULL, listesdescategoriesdupersonnage LONGTEXT NOT NULL, hpdebase INT NOT NULL, attaquedebase INT NOT NULL, defensedebase INT NOT NULL, hpmax INT NOT NULL, attaquemax INT NOT NULL, defensemax INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
