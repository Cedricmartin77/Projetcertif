 ...
 */
final class Version20220114124052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5FBDDD6BC9404EDE ON fiche_personnage_rarete_ssr (encyclopediedupersonnage_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5FBDDD6BC9404EDE ON fiche_personnage_rarete_ssr');
