 ...
 */
final class Version20220131201746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_personnage (id INT AUTO_INCREMENT NOT NULL, encyclopediedupersonnage_id INT NOT NULL, img VARCHAR(255) NOT NULL, aptitudeleader LONGTEXT NOT NULL, nomattaquespecial VARCHAR(255) NOT NULL, descriptionattaquespecial LONGTEXT NOT NULL, nomattaquespecialultime VARCHAR(255) DEFAULT NULL, descriptionattaquespecialultime LONGTEXT DEFAULT NULL, nomunitsuperattaque VARCHAR(255) DEFAULT NULL, descriptionunitsuperattaque LONGTEXT DEFAULT NULL, nomactiveskill VARCHAR(255) DEFAULT NULL, descriptionactiveskill LONGTEXT DEFAULT NULL, nompassiveskill VARCHAR(255) NOT NULL, descriptionpassiveskill LONGTEXT NOT NULL, listedesliensdupersonnage LONGTEXT NOT NULL, listedescategoriedupersonnage LONGTEXT NOT NULL, hpdebase INT NOT NULL, attaquedebase INT NOT NULL, defensedebase INT NOT NULL, hpmax INT NOT NULL, attaquemax INT NOT NULL, defensemax INT NOT NULL, INDEX IDX_C4BC4C9AC9404EDE (encyclopediedupersonnage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
