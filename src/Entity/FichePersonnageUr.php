...
#[ORM\Entity(repositoryClass: FichePersonnageUrRepository::class)]
class FichePersonnageUr
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(type: 'text')]
    private $listedeliensdupersonnage;
    ...
    #[ORM\ManyToOne(targetEntity: EncyclopedieDuPersonnage::class, inversedBy: 'fichePersonnageUrs')]
    ...
    public function getListedeliensdupersonnage(): ?string
    {
        return $this->listedeliensdupersonnage;
    }

    public function setListedeliensdupersonnage(string $listedeliensdupersonnage): self
    {
        $this->listedeliensdupersonnage = $listedeliensdupersonnage;
