...
class FichePersonnageUrActiveSkillType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('descriptionaptitudepassive', TextareaType::class, [
            ...
            ->add('activeskill', TextType::class, [
                'label' => 'Active skill',
                'attr' => [
                    'placeholder' => 'Ex.: Saiyan au coeur d\'or'
                ]
            ...
            ->add('listedescategoriesdupersonage', TextareaType::class, [
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => FichePersonnageUrActiveSkill::class,
        ]);
    }
}
